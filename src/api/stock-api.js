...
export const searchSymbols = async (query) => {
  const url = `${basePath}/search?q=${query}&token=cma0ql9r01qid8ge4hdgcma0ql9r01qid8ge4he0`;
...
export const fetchStockDetails = async (stockSymbol) => {
  const url = `${basePath}/stock/profile2?symbol=${stockSymbol}&token=cma0ql9r01qid8ge4hdgcma0ql9r01qid8ge4he0`;
  const response = await fetch(url);
...
export const fetchQuote = async (stockSymbol) => {
  const url = `${basePath}/quote?symbol=${stockSymbol}&token=cma0ql9r01qid8ge4hdgcma0ql9r01qid8ge4he0`;
  const response = await fetch(url);
...
export const fetchHistoricalData = async (
  ...
  const url = `${basePath}/stock/candle?symbol=${stockSymbol}&resolution=${resolution}&from=${from}&to=${to}&token=cma0ql9r01qid8ge4hdgcma0ql9r01qid8ge4he0`;
  const response = await fetch(url);
